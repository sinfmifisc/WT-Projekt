...
class ClosedSurveys extends Component {
    ...
    constructor(props) {
        ...
        componentDidMount(){
            axios.get('https://localhost:8443/loadclosedsurveys/' + localStorage.current_user + '/all', authHeader)
            .then((res) => {
        ...
        render(){
            ...
            return <Table size='large' className='selectable fixed' width='100%'>
                <Table.Header>
                    <Table.Row>
